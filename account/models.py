...
class CustomUserManager(BaseUserManager):
    ...
    def create_superuser(self, user_id, password=None, **extra_fields):
        ...
        defaults = {
            ...
            'ghana_card_number': 'GHA-0000000000',
            'social_security_number': 'SSN-0000000000',
            'national_health_insurance_number': 'NHIS-0000000000',
            'bank_name': 'Default Bank',
            'bank_account_number': '0000000000',
            'bank_account_branch': 'Head Office',
            'management_unit_cost_centre': 'HQ',
...
class User(AbstractUser):
    ...
    category = models.CharField(max_length=20) # same as class
